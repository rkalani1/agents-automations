...
Public-use boundary: Examples, evals, and starter kits must use synthetic placeholders only. Do not add real patient, employee, student, credential, confidential, or restricted data.
