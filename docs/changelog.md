...
All notable changes to this guide are documented here. Format loosely follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/). The repo-root mirror lives at [`/CHANGELOG.md`](https://github.com/example/agents-automations/blob/main/CHANGELOG.md).
